...
const DICTATE_SCRIPT: &str = r"%USERPROFILE%\Desktop\PAN\service\src\dictate-vad.py";
const VOICE_START_SND: &str = r"%USERPROFILE%\Desktop\PAN\service\bin\sounds\voice-start.wav";
const VOICE_STOP_SND: &str = r"%USERPROFILE%\Desktop\PAN\service\bin\sounds\voice-stop.wav";
